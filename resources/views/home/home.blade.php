...
@section('content')
        ...
        <header class="backdrop-brightness-50 grid grid-cols-1 divide-y pt-3 divide-[#bc9b75] text-white w-[98%] mx-auto">
            <div class="mb-1 flex justify-between md:text-[12px] text-[10px]">
                ...
                <b class="flex md:gap-2"> <img class="md:w-[25px] w-[20px]"
                        src="https://img.icons8.com/ios/50/FFFFFF/phone--v1.png" alt="phone--v1" /> +61 3 5208 1317</b>
            </div>
            <div></div>
        </header>
    ...
    <section class="bg-[url('/public/img/hero.jpg')] h-auto w-full bg-no-repeat bg-cover -mt-10">
        <h1
    ...
    <section
        ...
        <div class="w-full h-full flex flex-col gap-10 py-10 justify-center items-center backdrop-brightness-50">
            ...
            <h1 class="sm:text-5xl text-2xl">Awards for Rustic Ram Cafe and Restaurant</h1>
            <div class="flex lg:flex-row flex-col">
                <img class="rounded-xl mx-auto w-[600px] mt-5 z-50"
